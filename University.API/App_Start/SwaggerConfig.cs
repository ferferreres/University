                ...
                .EnableSwagger(c =>
                    {
                        ...
                        c.SingleApiVersion("v1", "University.API")
                            .Description("El proyecto de muestra es una aplicacion construida en .NET Framework " + 
                                         "con motor de base de datos en SQL Server para instituciones educativas. " + 
                                         "Incluye funcionalidades como admisión de estudiantes, creacion de cursos y tareas de instructor " + 
                                         "como matrículas y registros de notas.")
                            .TermsOfService("Terminos de Servicio")
                            .Contact(x => x.Name("Fernando Ferreres").Email("ferferreres98@gmail.com").Url("university-api.com"));
